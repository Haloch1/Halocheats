...
function initSharedFooter() {
  ...
  if (!inner.classList.contains("footer-grid")) {
    ...
    inner.innerHTML = `
      ...
      <nav class="footer-col" aria-label="Support links"><strong>Support</strong><a href="#" data-open-support>Help Desk</a><a href="/account/">Your Account</a><a href="/status/">Status</a><a href="https://discord.gg/xencheats" target="_blank" rel="noreferrer">Discord</a></nav>
