...
function renderThreads(threads) {
  ...
  document.title = unreadTotal > 0 ? `(${unreadTotal}) Desk Inbox | Nox Cheats` : "Desk Inbox | Nox Cheats";
  ...
  if (unreadTotal > previousUnreadCount && previousUnreadCount >= 0) {
    ...
    if (typeof Notification !== "undefined") {
      if (Notification.permission === "granted") {
        new Notification("Nox Cheats Support", { body: "You have a new reply from support.", icon: "/assets/hc-logo.png" });
