...
const productCatalog = [
  {
    ...
    variants: [
      keyVariant("crusader-r6", "day", "1 Day Key", 479),
      keyVariant("crusader-r6", "week", "1 Week Key", 1919),
      keyVariant("crusader-r6", "month", "1 Month Key", 3839),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("vega-r6-external", "day", "1 Day Key", 479),
      keyVariant("vega-r6-external", "three-day", "3 Day Key", 959),
      keyVariant("vega-r6-external", "week", "1 Week Key", 2399),
      keyVariant("vega-r6-external", "month", "1 Month Key", 4799),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("r6-frost", "day", "1 Day Key", 863),
      keyVariant("r6-frost", "week", "1 Week Key", 2687),
      keyVariant("r6-frost", "month", "1 Month Key", 4799),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("r6-ancient", "day", "1 Day Key", 659),
      keyVariant("r6-ancient", "week", "7 Day Key", 1799),
      keyVariant("r6-ancient", "month", "30 Day Key", 3599),
      keyVariant("r6-ancient", "lifetime", "Lifetime Key", 36239),
    ],
  },
  {
    ...r6Meta,
    ...
    requirements: ["Windows 10", "Windows 11 21H2 - 25H2", "UEFI based motherboard"],
    variants: [
      keyVariant("r6-recoil-private", "day", "1 Day Key", 191),
      keyVariant("r6-recoil-private", "week", "7 Day Key", 575),
      keyVariant("r6-recoil-private", "month", "30 Day Key", 1919),
      keyVariant("r6-recoil-private", "lifetime", "Lifetime Key", 2879),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("exodus-r6", "day", "1 Day Key", 287),
      keyVariant("exodus-r6", "three-day", "3 Day Key", 575),
      keyVariant("exodus-r6", "week", "7 Day Key", 1247),
      keyVariant("exodus-r6", "month", "30 Day Key", 1919),
    ],
    featureGroups: [
      {
        title: "Aimbot",
  ...
  },
  {
    ...
    variants: [
      keyVariant("invision-chams", "day", "1 Day Key", 287),
      keyVariant("invision-chams", "week", "7 Day Key", 1247),
      keyVariant("invision-chams", "month", "1 Month Key", 2399),
    ],
  },
  {
    ...r6Meta,
    ...
    requirements: ["Windows 10: 20H2 to 22H2", "Windows 11: 21H2 to 25H2"],
    variants: [
      keyVariant("r6-frost-lite", "day", "1 Day Key", 575),
      keyVariant("r6-frost-lite", "week", "1 Week Key", 1919),
      keyVariant("r6-frost-lite", "month", "1 Month Key", 3839),
    ],
  },
  {
    ...r6Meta,
    ...
    variants: [
      keyVariant("r6-unlock-all", "month", "1 Month Key", 2879),
      keyVariant("r6-unlock-all", "lifetime", "Lifetime Key", 6719),
    ],
  },
  {
    ...fortniteMeta,
    ...
    variants: [
      keyVariant("fortnite-full", "day", "1 Day Key", 575),
      keyVariant("fortnite-full", "week", "7 Day Key", 1247),
      keyVariant("fortnite-full", "month", "30 Day Key", 2399),
    ],
  },
  {
    ...fortniteMeta,
    ...
    variants: [
      keyVariant("fortnite-ancient", "day", "1 Day Key", 479),
      keyVariant("fortnite-ancient", "week", "7 Day Key", 2399),
      keyVariant("fortnite-ancient", "month", "30 Day Key", 4799),
    ],
  },
  {
    ...apexMeta,
  ...
  },
  {
    ...
    variants: [
      keyVariant("xim-spoofer", "day", "1 Day Key", 479),
      keyVariant("xim-spoofer", "three-day", "3 Days Key", 780),
      keyVariant("xim-spoofer", "week", "1 Week Key", 1651),
      keyVariant("xim-spoofer", "month", "1 Month Key", 3391),
      keyVariant("xim-spoofer", "lifetime", "Lifetime Key", 11004),
    ],
  },
  {
    ...accountsMeta,
    ...
    variants: [
      keyVariant("linked-nfa", "account", "1 NFA Account", 575),
    ],
  },
  {
    ...accountsMeta,
    ...
    requirements: ["Member account", "Valid contact method", "Support ticket required"],
    variants: [
      keyVariant("stacked-pc-account", "account", "1 NFA Stacked Linked Account", 1919),
    ],
  },
  {
    ...fortniteMeta,
    ...
    requirements: ["CPU: Intel / AMD", "OS: Windows 10 / 11"],
    variants: [
      keyVariant("disconnect-fortnite-external", "day", "1 Day Key", 864),
      keyVariant("disconnect-fortnite-external", "three-day", "3 Days Key", 1728),
      keyVariant("disconnect-fortnite-external", "week", "7 Days Key", 3360),
      keyVariant("disconnect-fortnite-external", "month", "30 Days Key", 6240),
      keyVariant("disconnect-fortnite-external", "lifetime", "Lifetime Key", 28800),
    ],
  },
  {
    ...fortniteMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("fortnite-ignite-aimbot", "day", "1 Day Key", 960),
      keyVariant("fortnite-ignite-aimbot", "three-day", "3 Days Key", 1920),
      keyVariant("fortnite-ignite-aimbot", "week", "7 Days Key", 3024),
      keyVariant("fortnite-ignite-aimbot", "month", "30 Days Key", 6720),
      keyVariant("fortnite-ignite-aimbot", "lifetime", "Lifetime Key", 40320),
    ],
  },
  {
    ...fortniteMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("fortnite-exodus", "day", "1 Day Key", 384),
      keyVariant("fortnite-exodus", "three-day", "3 Days Key", 768),
      keyVariant("fortnite-exodus", "week", "7 Days Key", 1920),
      keyVariant("fortnite-exodus", "month", "30 Days Key", 3840),
    ],
  },
  {
    ...rustMeta,
    ...
    requirements: ["Windows 10 / 11", "Intel or AMD CPU"],
    variants: [
      keyVariant("rust-ancient", "day", "1 Day Key", 360),
      keyVariant("rust-ancient", "week", "7 Days Key", 1500),
      keyVariant("rust-ancient", "month", "30 Days Key", 3000),
    ],
  },
  {
    ...rustMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("rust-exodus", "day", "1 Day Key", 192),
      keyVariant("rust-exodus", "three-day", "3 Days Key", 384),
      keyVariant("rust-exodus", "week", "7 Days Key", 960),
      keyVariant("rust-exodus", "month", "30 Days Key", 1920),
    ],
  },
  {
    ...rustMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("rust-ignite", "day", "1 Day Key", 461),
      keyVariant("rust-ignite", "three-day", "3 Days Key", 1037),
      keyVariant("rust-ignite", "week", "7 Days Key", 1440),
      keyVariant("rust-ignite", "month", "30 Days Key", 3456),
      keyVariant("rust-ignite", "lifetime", "Lifetime Key", 20736),
    ],
  },
  {
    ...rustMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("rust-krush", "day", "1 Day Key", 288),
      keyVariant("rust-krush", "week", "7 Days Key", 1440),
      keyVariant("rust-krush", "month", "30 Days Key", 2880),
    ],
  },
  {
    ...rustMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("rust-mek", "day", "1 Day Key", 461),
      keyVariant("rust-mek", "three-day", "3 Days Key", 922),
      keyVariant("rust-mek", "week", "7 Days Key", 1728),
      keyVariant("rust-mek", "month", "30 Days Key", 3456),
      keyVariant("rust-mek", "long", "9999 Day Key", 14400),
    ],
  },
  {
    ...spooferMeta,
    ...
    requirements: ["Windows 10 / 11", "Administrator access"],
    variants: [
      keyVariant("spoofer-exodus-temp", "day", "1 Day Key", 287),
      keyVariant("spoofer-exodus-temp", "three-day", "3 Days Key", 575),
      keyVariant("spoofer-exodus-temp", "week", "7 Days Key", 959),
      keyVariant("spoofer-exodus-temp", "month", "30 Days Key", 1919),
    ],
  },
  {
    ...spooferMeta,
    ...
    variants: [
      keyVariant("spoofer-verse-perm", "one-time", "One Time Key", 1919),
      keyVariant("spoofer-verse-perm", "lifetime", "Lifetime Key", 4799),
    ],
  },
];
